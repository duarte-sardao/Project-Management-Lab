...
const reorder = (how) => {
    form.selected = how;
    form.get(route('forum.post', {id: props.post_id}));
}

</script>

<template>
    <div class="dropdown dropdown-end w-[20vw]">
            <label tabindex="0" class="inline-block grid grid-cols-6 grid-flow-col justify-self-start py-[5px] text-center w-[100%] shadow-md bg-[#B9CEED] rounded-3xl text-xl font-black text-[#222222] hover:cursor-pointer">
